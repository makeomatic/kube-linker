...
import (
	...
	kubelinkerv1alpha1 "github.com/afoninsky/kube-linker/pkg/apis/kubelinker/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &kubelinkerv1alpha1.Config{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &kubelinkerv1alpha1.Config{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileConfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &kubelinkerv1alpha1.Config{}
...
func newPodForCR(cr *kubelinkerv1alpha1.Config) *corev1.Pod {
